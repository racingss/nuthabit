...
public class KehuUtil {
	...
	public Kehu getKehuByWeixin(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			k = createKehuByWeixin(request, response, openid, access_token);
	...
	public Kehu createKehuByWeixin(HttpServletRequest request, HttpServletResponse response, String openid,
