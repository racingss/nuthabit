          ...
          document.addEventListener('touchmove',function(e) {
            ...
            if(moving === true){
              for(let i = 0; i < touches.length; i++){
                  ...
                  // Apply the styles to the element
                  //console.log(touches[i].pageX+":"+document.getElementById('board').offsetWidth);
                  leftP=(touches[i].pageX-e.target.offsetWidth/2)/document.getElementById('board').offsetWidth*100;
                  //console.log(touches[i].pageY+":"+document.getElementById('board').offsetHeight);
                  topP=(touches[i].pageY-e.target.offsetHeight/2)/document.getElementById('board').offsetHeight*100;
                  var position = 'transform: translate('+dx+'px, '+dy+'px);z-index:'+z+';';
                  tgt.setAttribute('style', position);
              }
            };  
