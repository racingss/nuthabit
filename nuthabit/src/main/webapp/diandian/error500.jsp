...
<body>
	<div class="page parents">
		<div>
			<img class="bg" src="/diandian/frame/parents-11.png">
			<div style="background: white;padding: .5rem;margin: 1rem;border-radius: 0.2rem;position: relative;z-index: 2;">
				<h1 style="font-size: .45rem;text-align: center;">Error500</h1>
				<p style="font-size: .4rem;text-align:center;">
					<img alt="" src="/diandian/frame/erweima_adon.jpg" style="width: 5rem;padding-top: 1rem;">
					<br/>
					客服二维码
				</p>
			</div>
