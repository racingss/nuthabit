...
<br/>卡片点点上可由多人参与编辑的内容，包括但不限于卡片发布，卡片补充等，所有参与编辑者均同意，相关知识产权归卡片点点所有。
...
<br/>处理原则
<br/>
<br/>卡片点点作为儿童认知教育平台，高度重视自由表达和个人、企业正当权利的平衡。依照法律规定删除违法信息是卡片点点社区的法定义务，卡片点点社区亦未与任何中介机构合作开展此项业务。
<br/>
<br/>受理范围
<br/>
...
<br/>免责申明
<br/>
<br/>卡片点点不能对用户内容的正确性进行保证。
<br/>用户在卡片点点发布的内容仅表明其个人的立场和观点，并不代表卡片点点的立场或观点。作为内容的发表者，需自行对所发表内容负责，因所发表内容引发的一切纠纷，由该内容的发表者承担全部法律及连带责任。卡片点点不承担任何法律及连带责任。
