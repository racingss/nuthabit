...
public class HttpPostUtil {
	...
	private void writeFileParams() throws Exception {
		...
		for (Iterator<String> it = keySet.iterator(); it.hasNext();) {
			...
			outputStream.writeBytes("--" + boundary + "\r\n");
			outputStream.writeBytes("Content-Disposition: form-data; name=\"" + name + "\"; filename=\""
	...
	public static void main(String arg[]) {
		try {
			...
			util.addParameter("access_token", access);
			util.addParameter("type", "image");
			util.addParameter("media",
					new File("/Users/wangjunwu/git/nuthabit/nuthabit/src/main/webapp/diandian/haibao/qun1.jpeg"));
			String temp =util.send();
			System.out.println(temp);
			System.out.println(temp.substring(temp.indexOf("media_id")+11, temp.indexOf("created_at")-3));
		} catch (Exception e) {
