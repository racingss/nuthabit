...
public class ImageUtil {
	public  void downloadPicture(String urlList,String distUrl) {
		URL url = null;
		int imageNumber = 0;
     ...
     * @throws IOException
     */
	public void watermark(File file, File waterFile, int x, int y, float alpha,int width,int height,String savePath) throws IOException {
        // 获取底图
...
//			// 构建叠加层
//			BufferedImage buffImg = newImageUtils.watermark(new File(sourceFilePath), new File(waterFilePath), 70, 70, 1.0f);
//			// 输出水印图片
