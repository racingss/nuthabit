 ...
 * @date 2014-4-23 上午10:10:36
 */
@WebServlet("/testwx.html")
public class WeChatPayServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		if (isweixin) {
			...
			req.getRequestDispatcher("/gson_pay.jsp").forward(req, resp);
		} else {
			resp.sendRedirect("/gson_index.jsp");
		}
	}
