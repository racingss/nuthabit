...
public class Pay {
    ...
    public static String getPackage(Map<String, String> params) throws UnsupportedEncodingException {
        String partnerKey = "";
        String partnerId = "1504346731";
        String notifyUrl = "http://www.suyufuwu.com/diandian/weixinzhifuresult.html";
        // 公共参数
    ...
    public static String createSign(Map<String, String> params, boolean encode) throws UnsupportedEncodingException {
        ...
        temp.append("&key="+"1234drt67YTGHY6543dfgtr56789IJKU");
    ...
    public static String getSignValue(Map<String, String> params) throws UnsupportedEncodingException {
        String string1 = createSign(params, false);
        
        return  DigestUtils.md5Hex(string1).toUpperCase();
    }
    ...
    public static String paySign(String timestamp, String noncestr,String packages) throws UnsupportedEncodingException {
        ...
        paras.put("appid", "wx01dc3375ca2f8882");
        paras.put("timestamp", timestamp);
        paras.put("noncestr", noncestr);
        paras.put("package", packages);
        paras.put("appkey", "9d4c6cf58377cc59aa9139f404294c20");
