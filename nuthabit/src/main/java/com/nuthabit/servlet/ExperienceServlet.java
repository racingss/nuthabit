...
public class ExperienceServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("review") != null) {
			...
			MyplanExperience h = new MyplanExperience();
			h.setPlanId(m.getPlanId());
			h.setReview(request.getParameter("review"));
			h.setKehuId(k.getKehuId());
			h.setMainId(Long.parseLong(request.getParameter("experienceId")));
		...
		response.sendRedirect("detail.html?planId=" + id);
	}
